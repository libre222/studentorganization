...
<?php if (empty($student_list) || empty($event_list)): ?>
    <div class="alert warning">
        ⚠️ You need at least one
        <a href="../students/add.php" style="font-weight:600;color:inherit;text-decoration:underline;">student</a>
        and one
        <a href="../events/add.php" style="font-weight:600;color:inherit;text-decoration:underline;">event</a>
